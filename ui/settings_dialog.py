...
_INPUT_STYLE = (
    ...
    "background:white;border:1px solid #e0e8e4;border-radius:6px;"
    "padding:4px 8px;font-size:13px;color:#1a2332;min-height:28px;}"
    "QLineEdit:focus,QSpinBox:focus,QDoubleSpinBox:focus{border-color:#2f8f6b;}"
)
...
class SettingsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        tabs = QTabWidget()
        tabs.setStyleSheet("""
            QTabWidget::pane{background:white;border:1px solid #e0e8e4;border-radius:8px;}
            QTabBar::tab{background:#f4f7f5;color:#6b8a7a;padding:8px 16px;border:none;font-size:12px;}
            QTabBar::tab:selected{background:white;color:#2f8f6b;font-weight:bold;
        ...
        buttons.setStyleSheet("""
            QPushButton{background:#2f8f6b;color:white;border:none;border-radius:6px;
              padding:8px 20px;font-size:13px;}
            QPushButton:hover{background:#1e7558;}
            QPushButton[text="Cancel"]{background:#e0e8e4;color:#1a2332;}
            QPushButton[text="Cancel"]:hover{background:#cdd8d2;}
        """)
    ...
    def _build_general_tab(self) -> QWidget:
        ...
        browse_btn.setStyleSheet("QPushButton{background:#e0e8e4;border-radius:6px;border:none;padding:4px;}"
                                  "QPushButton:hover{background:#cdd8d2;}")
    ...
    def _build_ocr_tab(self) -> QWidget:
        ...
        note.setStyleSheet("color:#6b8a7a;font-size:11px;")
    ...
    def _build_email_tab(self) -> QWidget:
        ...
        self._smtp_to = QLineEdit(", ".join(to_list))
